locals {
  ...
  customer_managed_key_input = !local.use_customer_managed_key
    ? null
  ...
  customer_managed_key_identity_id = local.customer_managed_key_identity_type == "UserAssigned" && length(local.customer_managed_key_identity_id_candidates) > 0
